...
namespace DAL
{
    public class DALCT_BCLuotMuonTheoTheLoai
    {
        ...
        {
            return QLTVEntities.Instance.CT_BCLUOTMUONTHEOTHELOAI.AsNoTracking().ToList();
        }

        public CT_BCLUOTMUONTHEOTHELOAI GetCTBC(int idBC, int idTheLoai)
        {
            return QLTVEntities.Instance.CT_BCLUOTMUONTHEOTHELOAI.Find(new object[] { idBC, idTheLoai });
        }
        ...
        public bool AddCTBC(int idBC, int idTheLoai, int soLuotMuon)
        {
            try
            {
                ...
                QLTVEntities.Instance.CT_BCLUOTMUONTHEOTHELOAI.Add(ct);
        ...
        public bool DelCTBC(int idBC, int idTL)
        {
            try
            {
                ...
                QLTVEntities.Instance.CT_BCLUOTMUONTHEOTHELOAI.Remove(ct);
                QLTVEntities.Instance.SaveChanges();
                return true;
            }
            catch (Exception ex)
