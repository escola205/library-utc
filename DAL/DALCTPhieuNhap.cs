...
namespace DAL
{
    public class DALCTPhieuNhap
    {
        ...
        {
            return QLTVEntities.Instance.CT_PHIEUNHAP.AsNoTracking().ToList();
        }

        public CT_PHIEUNHAP GetCT_PHIEUNHAP(int soPhieu, int idSach)
        {
            return QLTVEntities.Instance.CT_PHIEUNHAP.Find(new object[] { soPhieu, idSach });
        }
        ...
        public bool AddCTPhieuNhap(int soPhieu, int idSach, int donGia, int soLuongNhap)
        {
            try
            {
                ...
                QLTVEntities.Instance.CT_PHIEUNHAP.Add(ct);
